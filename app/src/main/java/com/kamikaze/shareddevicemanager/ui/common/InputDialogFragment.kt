...
import kotlinx.android.synthetic.main.input_dialog.view.remarks_text
...
class InputDialogFragment : DialogFragment() {
    ...
    private val remarks: String by lazy {
        requireArguments().getString(KEY_REMARKS, "")
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        view.remarks_text.apply {
            text = remarks
            visibility = if (remarks.isNotEmpty()) {
                View.VISIBLE
            } else {
                View.GONE
            }
